...
namespace Projeto_Final.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,NomeCliente,CpfCliente,IdadeCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NomeCliente,CpfCliente,IdadeCliente")] Cliente cliente)
        {
