...
namespace Projeto_Final.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CnpjForncedor,NomeFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CnpjForncedor,NomeFornecedor")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
