...
namespace Projeto_Final.Controllers
{
    public class VendaHasProdutoController : Controller
    {
        ...
        {
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "MarcaCarro");
        ...
        public async Task<IActionResult> Create([Bind("VendaHasProdutoId,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "MarcaCarro", vendaHasProduto.ProdutoId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendaHasProdutoId,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
