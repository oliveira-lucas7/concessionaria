...
namespace Projeto_Final.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,NomeVendedor,IdadeVendedor,CpfVendedor")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,NomeVendedor,IdadeVendedor,CpfVendedor")] Vendedor vendedor)
        {
