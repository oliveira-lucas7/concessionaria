...
namespace Projeto_Final.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,MarcaCarro,ModeloCarro,CorCarro,PrecoProduto,CategoriaId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,MarcaCarro,ModeloCarro,CorCarro,PrecoProduto,CategoriaId,FornecedorId")] Produto produto)
        {
